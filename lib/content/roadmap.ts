...
export const roadmap: RoadmapPart[] = [
  {
    ...
    sections: [
      ...
      section(6, "Structs, Classes, and Enums"),
      section(7, "Protocols and Extensions"),
      section(8, "Generics"),
      section(9, "Error Handling"),
      section(10, "Memory Management"),
      section(11, "Advanced Type System"),
      section(12, "Result Builders and Property Wrappers"),
      section(13, "Macros"),
      section(14, "Standard Library Deep Dive"),
      section(15, "Low-Level Swift"),
      section(16, "Swift Evolution Literacy"),
    ],
  },
  {
    id: "part-2",
    title: "Concurrency",
    sections: [
      section(17, "Async/Await Foundations"),
      section(18, "Structured Concurrency"),
      section(19, "Actors and Isolation"),
      section(20, "Sendable and Data-Race Safety"),
      section(21, "AsyncSequence and Streams"),
      section(22, "Legacy Concurrency"),
    ],
  },
  {
    id: "part-3",
    title: "SwiftUI",
    sections: [
      section(23, "SwiftUI Fundamentals"),
      section(24, "Layout"),
      section(25, "State Management"),
      section(26, "Lists and Collections"),
      section(27, "Navigation and Presentation"),
      section(28, "Forms and Input"),
      section(29, "Animation"),
      section(30, "Drawing and Custom Graphics"),
